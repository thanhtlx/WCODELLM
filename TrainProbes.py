...
# df = pd.read_parquet('/drive2/thanhvt/lab/WCODELLM/benchmark/MBPP/data/mbpp_data_ramdom_first_last_classify_dataset.parquet')
# # df = pd.read_pickle('/drive2/thanhvt/lab/WCODELLM/benchmark/MBPP/data/mbpp_data_random_token_classify_dataset.pkl')
...
train_dataset = pd.read_parquet('/drive2/thanhvt/lab/WCODELLM/benchmark/MBPP/data/mbpp_data_ramdom_first_last_classify_train_dataset.parquet')
test_dataset = pd.read_parquet('/drive2/thanhvt/lab/WCODELLM/benchmark/MBPP/data/mbpp_data_ramdom_first_last_classify_test_dataset.parquet')
...
# train_dataset.to_parquet('/drive2/thanhvt/lab/WCODELLM/benchmark/MBPP/data/mbpp_data_ramdom_first_last_classify_train_dataset.parquet')
# test_dataset.to_parquet('/drive2/thanhvt/lab/WCODELLM/benchmark/MBPP/data/mbpp_data_ramdom_first_last_classify_test_dataset.parquet')
